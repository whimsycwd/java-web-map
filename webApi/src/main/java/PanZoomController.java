...
public class PanZoomController {
	...
	public void relax(){ //added to smooth zoom & pan
		curScale += (scale - curScale)/chaceDelay;
		curPan.x += (pan.x - curPan.x)/chaceDelay;
		curPan.y += (pan.y - curPan.y)/chaceDelay;
	}
	...
	public void setFinalPan(PVector pan) {
		this.pan = pan;
	}
